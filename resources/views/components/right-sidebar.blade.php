...
<div class="sidebar sidebar-right sidebar-animate">
    <div class="panel panel-primary card mb-0 box-shadow">
        <div class="px-4 py-3 sidebar-icon d-flex align-items-center justify-content-between bg-primary-light">
            ...
            <a href="javascript:void(0)" class="text-end float-end" data-bs-toggle="sidebar-right" data-bs-target=".sidebar-right"><i class="fe fe-x"></i></a>
        </div>
        <div class="tab-menu-heading siderbar-tabs border-0">
            <div class="tabs-menu">
                <!-- Tabs -->
                <ul class="nav panel-tabs">
                    <li class=""><a href="#tab01" class="active" data-bs-toggle="tab"><i class="fe fe-mail me-1"></i>Chat</a></li>
                    <li><a href="#tab02" data-bs-toggle="tab"><i class="fe fe-activity me-1"></i>Activity</a></li>
                    <li><a href="#tab03" data-bs-toggle="tab"><i class="fe fe-edit-3 me-1"></i>Todo</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="tab-content border-top">
                        ...
                        <div>
                            ...
                            <ul class="mb-0 list-group list-group-flush">
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/male/32.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                    ...
                                    <div class="ms-auto text-end mt-1">
                                        ...
                                        <span class="p-1 fs-7 lh-1 bg-success fws-emibold rounded-circle">24</span>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/1.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/21.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                            <h6 class="mt-1 mb-0 fw-semibold">Maryam Naz</h6>
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/23.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/male/33.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                    ...
                                    <div class="ms-auto text-end mt-1">
                                        ...
                                        <span class="p-1 fs-7 lh-1 bg-success fws-emibold rounded-circle">10</span>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/male/15.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/15.jpg')}}">
                                            <span class="avatar-status bg-green"></span>
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                            <h6 class="mt-1 mb-0 fw-semibold">Khadija Mehr</h6>
                                    ...
                                    <div class="ms-auto text-end mt-1">
                                        ...
                                        <span class="p-1 fs-7 lh-1 bg-success fws-emibold rounded-circle">06</span>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="mb-0 list-group list-group-flush">
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/male/10.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/9.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                ...
                                <li class="list-group-item d-flex border-0">
                                    <div class="d-flex">
                                        <span class="avatar brround avatar-md cover-image" data-bs-image-src="{{asset('build/assets/images/users/female/11.jpg')}}">
                                        </span>
                                        <a href="{{url('chat')}}" class="ms-2 p-0">
                                            <h6 class="mt-1 mb-0 fw-semibold">Yolduz Rafi</h6>
                ...
                <div class="tab-pane" id="tab02">
                    ...
                    <ul class="list-group list-group-flush mb-2 mt-4">
                        ...
                        <li class="list-group-item d-flex border-0">
                            <div>
                                <i class="fe fe-check-circle p-3 fs-6 bg-purple-transparent rounded-circle"></i>
                            </div>
                            <div class="w-100 ms-3">
                                <h6 class="mb-0 fw-semibold">
